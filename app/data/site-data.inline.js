window.__SITE_DATA__ = {
  ...
  "copy": {
    ...
    "hero": {
      ...
      "body": "这站先把事实写干净。赛程、比分、赛段、队伍走势直接上墙；该等待补链的地方老老实实写清楚，不拿花活糊你。",
      "tags": [
        "官源赛程",
        "战队卷宗",
        "主队关注席",
    ...
    "sections": {
      ...
      "dataBrief": {
        "eyebrow": "数据口径",
        "title": "只把能确认的写上墙",
        "body": "官网当前只接腾讯英雄联盟赛事公开赛程文件，覆盖 LPL 第一赛段与 First Stand。选手个人 Rank、个人对局与 LCK 全链路，暂时没有混进来装懂。"
      }
    },
    "nav": {
      "overview": "山门",
  ...
  "heroMatch": {
    ...
    "headline": "BLG 对 G2",
    "summary": "BLG 最近一场刚打完 G2，现在先拿落地赛果说话。",
    "left": {
      "code": "BLG",
      "sub": "LPL 第一赛段冠军",
  ...
  "overview": {
    ...
    "spotlight": {
      ...
      "role": "上路",
      "teamCode": "BLG",
      "summary": "边线处理极具压迫感，擅长在资源置换中通过单带深度撕裂对手防线。",
      "note": "需持续关注其对兵线推深时机的抉择，那是衡量其对全局影响力最直观的刻度。",
      "tags": [
        "主队关注",
        "真实赛历",
        "不装 Rank"
      ...
      "observation": [
        "需持续关注其对兵线推深时机的抉择，那是衡量其对全局影响力最直观的刻度。",
        "最近一场 BLG 3:0 G2。",
        "下一场还没到已确认对阵。"
      ],
      "history": [
    ...
    "items": [
      {
        ...
        "statement": "凭借十二胜四负的战绩及五连胜势头稳居首位，展现出极高的竞技容错率与战术执行力。",
        "metrics": [
          {
            "label": "胜率",
            "value": 75,
      ...
      },
      {
        ...
        "statement": "LPL 第一赛段亚军已经落地。下一场对 LYON，看点不会少。",
        "metrics": [
          {
            "label": "胜率",
            "value": 53,
      ...
      },
      {
        ...
        "statement": "LPL 第一赛段四强已经落地。当前还没有下一场已确认对阵。",
        "metrics": [
          {
            "label": "胜率",
            "value": 71,
      ...
      },
      {
        ...
        "statement": "这队近况够硬，账面也好看。当前还没有下一场已确认对阵。",
        "metrics": [
          {
            "label": "胜率",
            "value": 88,
      ...
      },
      {
        ...
        "statement": "起伏还在，前十五分钟尤其要盯。当前还没有下一场已确认对阵。",
        "metrics": [
          {
            "label": "胜率",
            "value": 43,
  ...
  "players": {
    ...
    "items": [
      ...
      },
      {
        ...
        "role": "打野",
        "teamCode": "BLG",
        "summary": "XUN 当前挂在 BLG 关注席，先把归队、赛历和所在战队近况看清。",
        "note": "看前十五分钟河道控制和第一波节奏落点。",
        "tags": [
          "主队关注",
          "真实赛历",
          "不装 Rank"
      ...
      },
      {
        ...
        "role": "中路",
        "teamCode": "BLG",
        "summary": "Knight 当前挂在 BLG 关注席，先把归队、赛历和所在战队近况看清。",
        "note": "看中期第一波接团和法核收束能力。",
        "tags": [
          "主队关注",
          "真实赛历",
          "不装 Rank"
      ...
      },
      {
        ...
        "role": "下路",
        "teamCode": "BLG",
        "summary": "Viper 当前挂在 BLG 关注席，先把归队、赛历和所在战队近况看清。",
        "note": "看线权处理和中后段收口是不是够稳。",
        "tags": [
          "主队关注",
          "真实赛历",
          "不装 Rank"
      ...
      },
      {
        ...
        "role": "辅助",
        "teamCode": "BLG",
        "summary": "ON 当前挂在 BLG 关注席，先把归队、赛历和所在战队近况看清。",
        "note": "看开团时机和失误率，别只盯高光。",
        "tags": [
          "主队关注",
          "真实赛历",
          "不装 Rank"
    ...
    "items": [
      {
        ...
        "actualScore": "0:0",
        "headline": "局势胶着，BFX 尝试在系列赛中寻求突破",
        "line": "双方胜负交替且局差微弱，博弈重点在于后期团战的资源分配。",
        "risk": "G2 的战术不可控性可能导致数值预测偏差，需警惕低概率变数。"
      },
      {
        "id": "13204",
        ...
        "fallback": {
          "headline": "JDG 稍占先手",
          "line": "JDG 的账面更厚，赛前可以先往这边看，但别把风险当空气。",
        ...
        "actualScore": "0:0",
        "headline": "JDG 纸面实力占优，LYON 面临严峻线权考验",
        "line": "64% 的胜率预测基于过往局差表现，JDG 需保持节奏连贯性。",
        "risk": "近期连胜状态的不稳定是潜在变量，需关注打野位的前期落点。"
      },
      {
        "id": "13199",
        ...
        "fallback": {
          "headline": "BLG 已经兑付",
          "line": "BLG 这场把结果写死了，赛果摆在墙上，不用再靠嘴硬。",
        ...
        "actualScore": "3:0",
        "headline": "预测兑现：BLG 以统治级表现终结系列赛",
        "line": "84% 的高置信度源于五连胜状态与极高的局差正值。",
        "risk": "已根据最终 3:0 赛果完成数据结算，风险点已随比赛结束闭合。"
      }
    ],
    "blueprint": {
      "steps": [
